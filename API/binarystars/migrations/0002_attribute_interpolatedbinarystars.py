...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Attribute',
            fields=[
                ('database_name', models.TextField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menv_1', models.DecimalField(blank=True, decimal_places=30, max_digits=50, null=True)),
                ('renv_1', models.DecimalField(blank=True, decimal_places=30, max_digits=50, null=True)),
                ('epoch_1', models.DecimalField(blank=True, decimal_places=30, max_digits=50, null=True)),
                ('ospin_1', models.FloatField(blank=True, null=True)),
                ('deltam_1', models.DecimalField(blank=True, decimal_places=30, max_digits=50, null=True)),
                ...
                ('menv_2', models.DecimalField(blank=True, decimal_places=30, max_digits=50, null=True)),
                ('renv_2', models.DecimalField(blank=True, decimal_places=30, max_digits=50, null=True)),
                ('epoch_2', models.DecimalField(blank=True, decimal_places=30, max_digits=50, null=True)),
                ('ospin_2', models.FloatField(blank=True, null=True)),
                ('deltam_2', models.DecimalField(blank=True, decimal_places=30, max_digits=50, null=True)),
                ...
                ('b_0_1', models.DecimalField(blank=True, decimal_places=20, max_digits=50, null=True)),
                ('b_0_2', models.DecimalField(blank=True, decimal_places=20, max_digits=50, null=True)),
